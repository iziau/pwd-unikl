function test_model() {
  $.getJSON("https://pwd-unikl.herokuapp.com/master/static/classifier.json", function(clfdata) {
    var rf = random_forest(clfdata);
    $.getJSON("https://pwd-unikl.herokuapp.com/master/static/testdata.json", function(testdata) {
